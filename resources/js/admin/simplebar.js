    ...
    t &&
        window.addEventListener('resize', function () {
            M !== window.devicePixelRatio &&
                ((M = window.devicePixelRatio), (W = null))
        })
    var C = function (e) {
        ...
        X = (function () {
            function e (t, i) {
                ...
                ;(this.onMouseMove = (function (e, t, i) {
                    ...
                    (this.onWindowResize = A(this._onWindowResize, 64, {
                        leading: !0
                    })),
                    (this.onStopScrolling = A(
                        this._onStopScrolling,
                        this.stopScrollDelay
                    )),
                    (this.onMouseEntered = A(
                ...
                (e.prototype.onMouseMoveForAxis = function (e) {
                    ...
                    t.track.el &&
                        ...
                        this.isWithinBounds(t.track.rect)
                            ...
                            : (q(t.track.el, this.classNames.hover),
