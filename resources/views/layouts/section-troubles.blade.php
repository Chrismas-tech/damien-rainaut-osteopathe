        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="250">
                <div class="action-card primary">
                    ...
                    <p class="mb-0">Trachéites<br>Bronchites<br>Asthme</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="350">
                <div class="action-card primary">
                    ...
                    <p class="mb-0">Cystites<br>Troubles de la prostate<br>Incontinences<br>Énurésie</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="400">
                <div class="action-card primary">
                    ...
                    <p class="mb-0">Normalisation du cycle<br>Règles douloureuses<br>Infertilité<br>Troubles de
                        la ménopause</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="450">
                <div class="action-card primary">
                    ...
                    <p class="mb-0">Palpitations<br>Oppressions thoraciques<br>Jambes lourdes<br>Maladie de
                        Raynaud</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="500">
                <div class="action-card primary">
                    ...
                    <p class="mb-0">Céphalées<br>Migraines<br>Insomnies<br>Anxiété</p>
                </div>
            </div>
        </div>
    </div>
