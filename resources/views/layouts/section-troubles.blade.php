<section id="service-details-2" class="service-details-2 section">
    ...
    <div class="row gy-4">
        <div class="col-12 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="container section-title aos-init aos-animate mt-5" data-aos="fade-up">
        <h2>Je peux prendre en charge tous les problèmes ci- dessous…</h2>
    </div>
    <div class="row gy-4">
        ...
        <div class="col-lg-4 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="200">
            <div class="action-card primary">
                <div class="card-header">
                    <img class="img-troubles" src="{{ asset('img/website/damien/troubles/douleurs-articulaires.png') }}"
