                    ...
                    <table class="table table-bordered table-hover align-middle text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Traitement préventif des 78 % de TMS</td>
                                <td><i class="bi bi-check-circle text-success fs-4 me-2"></i>Réduction directe des coûts
                                    d'arrêt de travail</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-graph-up-arrow text-primary fs-4 me-2"></i>Productivité</td>
                                <td>Optimisation de la posture et de la respiration</td>
                                <td><i class="bi bi-check-circle text-success fs-4 me-2"></i>Collaborateurs plus alertes
                                    et moins fatigués physiquement</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-people text-primary fs-4 me-2"></i>Marque Employeur</td>
                                <td>Mise en place de journées QVT dédiées</td>
                                <td><i class="bi bi-check-circle text-success fs-4 me-2"></i>Fidélisation des talents et
                                    climat social positif</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-shield-lock text-primary fs-4 me-2"></i>Sécurité (Santé)</td>
                                <td>Diagnostic d'exclusion et orientation médicale</td>
                                <td><i class="bi bi-check-circle text-success fs-4 me-2"></i>Prévention des accidents et
                                    conformité santé</td>
                            </tr>
                        </tbody>
                    </table>
