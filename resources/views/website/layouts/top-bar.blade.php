      ...
      <div class="topbar d-flex align-items-center dark-background">
          <div class="container d-flex justify-content-center justify-content-md-between">
              ...
              <div class="social-links d-none d-md-flex align-items-center">
                  <a href="{{ App\Models\Website::getSettings()->link_twitter }}" target="_blank" class="me-2"><i
                          class="bi bi-twitter-x"></i></a>
                  <a href="{{ App\Models\Website::getSettings()->link_facebook }}" target="_blank" class="me-2"><i
                          class="bi bi-facebook"></i></a>
                  <a href="{{ App\Models\Website::getSettings()->link_instagram }}" target="_blank" class="me-2"><i
