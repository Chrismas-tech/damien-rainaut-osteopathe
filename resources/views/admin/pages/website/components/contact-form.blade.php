    ...
    <div class="px-6 my-6">
        <div class="card shadow">
            ...
            <div class="card-body flex items-center mb-4">
                <i class="fa-regular fa-rectangle-list fa-2x me-2 text-indigo-600 mr-2"></i>
                <h4>Contact Form</h4>
            </div>
            ...
            <div class="tab-content p-6" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-livewire" role="tabpanel" aria-labelledby="pills-livewire-tab"
                    ...
                    <div class="code relative">
                        ...
                        @php
                            $text = '@livewire(\'website.components.contact-form\')';
                        @endphp
                    ...
                    <div class="code relative">
                        ...
                        @php
                            $html = file_get_contents(
                                resource_path('views/livewire/admin/website/components/contact-form.blade.php'),
                            );
                        @endphp
                        <textarea rows="25"
