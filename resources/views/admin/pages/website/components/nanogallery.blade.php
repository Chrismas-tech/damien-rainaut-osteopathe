            ...
            <div class="tab-content p-6" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-livewire" role="tabpanel" aria-labelledby="pills-livewire-tab"
                    ...
                    <div class="code relative">
                        ...
                        @php
                            $text = '@livewire(\'admin.website.components.nanogallery\')';
                        @endphp
                    ...
                    <div class="code relative">
                        ...
                        @php
                            $html = file_get_contents(
                                resource_path('views/livewire/admin/website/components/nanogallery.blade.php'),
                            );
                        @endphp
                        <textarea rows="25"
