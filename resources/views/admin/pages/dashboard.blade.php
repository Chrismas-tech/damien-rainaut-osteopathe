    ...
    <div class="p-6">
        <div class="mb-4">
            ...
            <input type="text" disabled
                class="text-gray-900 font-bold px-4 text-lg block w-full border-gray-300 rounded focus:border-indigo-600 focus:ring-indigo-600 disabled:opacity-50 disabled:pointer-events-none"
                id="currentPassword" value="{{ Auth()->user()->role === 'admin' ? 'Administrator' : '' }}" />
        </div>

        @livewire('admin.profile.update-name-and-email-form')
        @livewire('admin.profile.update-password-form')

        {{-- @livewire('admin.profile.delete-account-form') --}}
        ...
        <div class="block">
            <div class="flex items-center p-5 rounded-t-md shadow bg-cover bg-no-repeat pt-28"
                style="background-image: url({{ asset('img/admin//background/profile-cover.jpg') }})"></div>
                ...
                <div class="flex items-center justify-between pt-4 pb-6 px-4">
                    <div class="flex items-center">
                        ...
                        <div class="w-24 h-24 mr-2 relative flex justify-end items-end -mt-10">
                            <img src="assets/images/avatar/avatar-1.jpg" class="rounded-full border-4 border-white"
                                alt="" />
                            <a href="#!" class="absolute top-0 right-0 mr-2" data-bs-toggle="tooltip"
                                data-placement="top" title="" data-original-title="Verified"
                                data-bs-original-title="">
                                <img src="{{ asset('img/admin//svg/checked-mark.svg') }}" alt="" height="30"
                                    width="30" />
                            </a>
                        </div>
                        <!-- text -->
                        <div class="leading-4">
                            ...
                            <p class="mb-0 text-gray-500">{{ Auth()->user()->email }}n</p>
                        </div>
                    </div>
                    <div>
                        <a href="#"
                            class="btn bg-indigo-600 text-white border-indigo-600 hover:bg-indigo-800 hover:border-indigo-800 active:bg-indigo-800 active:border-indigo-800 focus:outline-none  focus:ring-indigo-300 md:visible invisible">
                            Edit Profile
                        </a>
                    </div>
                </div>
