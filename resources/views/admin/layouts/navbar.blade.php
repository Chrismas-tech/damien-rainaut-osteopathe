        ...
        <ul class="flex ml-auto items-center">
            ...
            <li class="dropdown ml-2">
                <a class="rounded-full" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown"
                    ...
                    <div class="w-10 h-10 bg-primary relative rounded-full">
                        <div
                            class="absolute text-white text-lg font-bold translate-x-2/4 -translate-y-2/4 rounded-full top-2/4 right-2/4">
                            <div class="flex">
                                <span>
                    ...
                    {{--  <div class="w-10 h-10 relative">
                        <img alt="avatar" src="{{ asset('img/admin//avatar/avatar-1.jpg') }}"
                            class="rounded-full" />
                        <div
                ...
                <div class="dropdown-menu dropdown-menu-end p-2" aria-labelledby="dropdownUser">
                    <div class="px-4 pb-0 pt-2 border-b border-gray-300">
                        <div class="leading-4 text-center">
                            <h4 class="mb-2">{{ Auth()->user()->firstname }}</h4>
